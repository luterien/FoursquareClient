"""
Django settings for foursquareClient project.
...
SECRET_KEY = 'cx8hz_v6@-^grr@q8zzoy+a4-pn-=*nj8_&v1qovb7!k+n=g6!'
...
WSGI_APPLICATION = 'foursquareClient.wsgi.application'
